      ...
      <div className="min-h-screen py-8 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
            ...
            <div
              className={`p-6 border border-offwhite-200 rounded-xl shadow-sm ${saldoMes >= 0 ? 'bg-green-50' : 'bg-red-50'}`}>
              <div className="flex items-center gap-2 text-sm text-navy-600 mb-2">
                {saldoMes >= 0 ? (
          ...
          {modalAberto && modalContexto !== 'novaMensalidade' && (
            <div className="fixed inset-0 z-50 flex items-center justify-center">
              ...
              <div
                className="relative bg-white rounded-2xl shadow-lg w-full max-w-md mx-4 p-6 z-10 border border-offwhite-200">
                ...
                <form onSubmit={salvarPagamento} className="space-y-4">
                  ...
                  <div className="flex justify-end gap-2 pt-4">
                    ...
                    <button type="submit"
                      className="px-4 py-2 bg-red-600 text-white rounded-lg flex items-center gap-2 hover:bg-red-700 transition-colors shadow-sm font-medium">
                      <PaymentsIcon fontSize="small"/>
              ...
              <div
                ...
                <form onSubmit={salvarNovaMensalidade} className="space-y-4">
                  ...
                  <div className="flex justify-end gap-2 pt-4">
                    ...
                    <button type="submit"
                      className="px-4 py-2 bg-green-600 text-white rounded-lg flex items-center gap-2 hover:bg-green-700 transition-colors shadow-sm font-medium">
                      <AddIcon fontSize="small"/>
                      Criar Mensalidade
                    </button>
                  </div>
