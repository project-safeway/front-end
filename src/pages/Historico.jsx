    ...
    <div className="py-6">
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          ...
          <p className="text-navy-600">Visualize o histórico de todas as atividades</p>
        </div>
      </div>
      ...
      <div className="bg-offwhite-50 border border-offwhite-200 rounded-xl shadow-sm p-8">
        <div className="text-center py-12">
          <HistoryIcon className="text-navy-300 text-6xl mb-4" />
          <h2 className="text-2xl font-semibold text-navy-800 mb-2">
            Módulo de Histórico
          </h2>
          <p className="text-navy-600 mb-6">
            Em breve: Sistema de visualização de histórico de atividades
          </p>
